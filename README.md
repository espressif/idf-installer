...
| ------- | ------- | ---- |
| Espressif-IDE v2.11.1 and ESP-IDF 5.1.1 [download](https://github.com/espressif/idf-installer/releases/download/espressif-ide-2.11.1-esp-idf-5.1.1/espressif-ide-setup-2.11.1-with-esp-idf-5.1.1.exe)/[mirror](https://dl.espressif.com/dl/idf-installer/espressif-ide-setup-2.11.1-with-esp-idf-5.1.1.exe) | Espressif-IDE 2.11.1 + JDK 17 + ESP-IDF v5.1.1 | 1 GB |
| Espressif-IDE v2.11.0 and ESP-IDF 5.1.1 [download](https://github.com/espressif/idf-installer/releases/download/espressif-ide-2.11.0-esp-idf-5.1.1/espressif-ide-setup-2.11.0-with-esp-idf-5.1.1.exe)/[mirror](https://dl.espressif.com/dl/idf-installer/espressif-ide-setup-2.11.0-with-esp-idf-5.1.1.exe) | Espressif-IDE 2.11.0 + JDK 17 + ESP-IDF v5.1.1 | 1 GB |
...
| ESP-IDF v4.1.4 [download](https://github.com/espressif/idf-installer/releases/download/offline-4.1.4/esp-idf-tools-setup-offline-4.1.4.exe)/[mirror](https://dl.espressif.com/dl/idf-installer/esp-idf-tools-setup-offline-4.1.4.exe) | ESP-IDF + Toolchains for ESP32, ESP32-S2 | 353 MB |
