...
| ------- | ------- | ---- |
| Espressif-IDE v2.11.0 and ESP-IDF 5.1.1 [download](https://github.com/espressif/idf-installer/releases/download/espressif-ide-2.11.1-esp-idf-5.1.1/espressif-ide-setup-2.11.1-with-esp-idf-5.1.1.exe)/[mirror](https://dl.espressif.com/dl/idf-installer/espressif-ide-setup-2.11.1-with-esp-idf-5.1.1.exe) | Espressif-IDE 2.11.1 + JDK 17 + ESP-IDF v5.1.1 | 1 GB |
