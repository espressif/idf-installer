...
| ------- | ------- | ---- |
| Espressif-IDE v2.7.0 [download](https://github.com/espressif/idf-installer/releases/download/espressif-ide-2.7.0/espressif-ide-setup-espressif-ide-2.7.0-with-esp-idf-4.4.3.exe)/[mirror](https://dl.espressif.com/dl/idf-installer/espressif-ide-setup-espressif-ide-2.7.0-with-esp-idf-4.4.3.exe) | Espressif-IDE + JDK + ESP-IDF v4.4.3 | 1 GB |
