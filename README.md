...
| ESP-IDF v4.3.5 [download](https://github.com/espressif/idf-installer/releases/download/offline-4.3.4/esp-idf-tools-setup-offline-4.3.5.exe)/[mirror](https://dl.espressif.com/dl/idf-installer/esp-idf-tools-setup-offline-4.3.5.exe) | ESP-IDF + Toolchains for ESP32, ESP32-S2, ESP32-S3,
ESP32-C3 | 570 MB |
